    ...
    <div className="w-full">
      <div className="flex overflow-hidden cursor-pointer">
        ...
        <div className="absolute md:py-16 2xs:mt-8 md:mt-28 md:ml-16 z-30">
          <h1 className="xs:text-xs sm:text-2xl md:text-4xl font-semibold 2xs:ml-2 2xs:w-6/12 md:w-5/12 text-black">
            MALO Reinigung GmbH
          </h1>
      ...
      <div className=" flex md:overflow-hidden 2xs:mt-2 cursor-pointer md:pbs-10">
        <div className="md:w-1/2 2xs:w-3/5 xs:w-full">
          <img src={page2} className="flex mt-2" />
        </div>
        <div className="md:w-1/2 2xs:w-2/5 md:-mt-24 md:mr-56">
          <img src={drop} className="md:ml-auto 2xs:-mt-4 2xs:w-full"/>
